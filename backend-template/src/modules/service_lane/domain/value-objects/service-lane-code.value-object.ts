...
const NAME = 'ServiceLaneCode';

export class ServiceLaneCodeValueObject extends ValueObject<Props> {
    public get value() {
    ...
    public static create(props: Props): Result<ServiceLaneCodeValueObject> {
        ...
        return Result.success(
            new ServiceLaneCodeValueObject({
